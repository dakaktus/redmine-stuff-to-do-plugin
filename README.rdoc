...
3. Login as administrator, set permissions for Roles and enable module in projects 
4. Click the Stuff To Do link in the top left menu
...
Hiroponz - for translation and routes fix
